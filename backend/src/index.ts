...
import employeeImageRoutes from './routes/employee-images';
import salaryRoutes from './routes/salary';
import reportTemplateRoutes from './routes/report-template';
...
import finAccountsRoutes from './routes/fin-accounts';
import userFilesRoutes from './routes/user-files';
import sharedFilesRoutes from './routes/shared-files';
import userNotesRoutes from './routes/user-notes';
import userDocumentsRoutes from './routes/user-documents';
...
// New v2 routes
import { financialV2Routes } from './modules/financial/financial.routes';
